...
and ?n? is the distance screwed in revolutions.Next, the vertical movement of 
the crown must be translated into the radial displacement of the back
stops. Since each rail is independent but identical, they can be considered 
from a perspective of a 2D
cross section. The radial displacement can therefore be considered as a 
horizontal motion along the
rail. By considering trigonometry and accounting for the mount?s tolerances, 
the horizontal
